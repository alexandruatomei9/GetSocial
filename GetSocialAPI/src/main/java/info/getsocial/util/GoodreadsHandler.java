...
public class GoodreadsHandler extends DefaultHandler {
	...
	/*
	 * List of elements we can encounter in this xml and needed to build up the
	 * POJO objects.
	 */
	...
	/*
	 * Needed to know context of element (ie: name can be name of book or name
	 * of author).
	 */
	...
	public GoodreadsHandler() {
		...
		branchInXML = ELEM_BOOK; // first element in the xml structure we need
									// to interpret is book
	}
	 ...
	 * java.lang.String, java.lang.String, org.xml.sax.Attributes) This method
	 * is called at the start of any dom element
	 */
